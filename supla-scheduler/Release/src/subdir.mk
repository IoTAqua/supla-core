...
src/%.o: ../src/%.cpp
	...
	g++ -O3 -Wall $(CPPFLAGS) -c -fmessage-length=0 -fstack-protector-all -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
...
src/%.o: ../src/%.c
	...
	gcc -O3 -Wall $(CFLAGS) -c -fmessage-length=0 -fstack-protector-all -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
